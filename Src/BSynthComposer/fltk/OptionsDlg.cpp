...
ProjectOptionsDlg::ProjectOptionsDlg()
	: Fl_Window(100, 100, 500, 500, "Project Options")
{
	int txtHeight = 25;
	int txtSpace = 30;
	int ypos = 5;

	nameInp = new Fl_Input(90, ypos, 400, txtHeight, "Author: ");
	nameInp->value(prjOptions.defAuthor);
	ypos += txtSpace;

	cpyrInp = new Fl_Input(90, ypos, 400, txtHeight, "Copyright: ");
	...
	prjfInp = new Fl_Input(90, ypos, 400, txtHeight, "Project Files: ");
...
//	prjfBrowse->callback(BrowseCB, (void*)&prjfInp);
	...
	wvinInp = new Fl_Input(90, ypos, 400, txtHeight, "Wave Files: ");
...
//	wvinBrowse->callback(BrowseCB, (void*)&wvinInp);
	...
	formInp = new Fl_Input(90, ypos, 400, txtHeight, "Form Files: ");
...
//	libsBrowse->callback(BrowseCB, (void*)libsInp);
	...
	okBtn = new Fl_Button(380, ypos, 50, txtHeight, "OK");
	okBtn->callback(OkCB, (void*)this);

	canBtn = new Fl_Button(440, ypos, 50, txtHeight, "Cancel");
	canBtn->callback(CanCB, (void*)this);
	ypos += txtSpace;

	end();
	resize(mainWnd->x()+100, mainWnd->y()+100, 500, ypos+5);
}
